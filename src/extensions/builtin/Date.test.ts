...
describe("Date", () => {
  ...
  const testCases = [
    ...
    ["08:00", -1, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), 9))],
    ["08:00", 8, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate()))],
    ["08:00", -8, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), 16))],
    ["08:00", 12, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate() - 1, 20))],
    ["08:00", -12, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), 20))],

    ["0800", 0, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), 8))],
    ["0800", 1, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), 7))],
    ["0800", -1, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), 9))],
    ["0800", 8, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate()))],
    ["0800", -8, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), 16))],
    ["0800", 12, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate() - 1, 20))],
    ["0800", -12, new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate(), 20))],
  ] as const;

  for (const [input, tz, expected] of testCases) {
    test("parseTime", () => {
      const actual = Date.parseTime(input, tz);
